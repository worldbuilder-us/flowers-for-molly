    ...
    //
    {
      ...
      assets: [
        ...
        },
        {
          ...
          height: 520,
          xPositions: [
            40, 80, 120, 240, 300, 360, 440, 540, 650, 720, 840, 1240, 1640,
            2040, 2440, 2840, 3240, 3640,
          ],
        },
        {
          name: "grass",
      ...
      assets: [
        {
          ...
          width: 520,
          height: 700,
          xPositions: [80, 360, 560, 1040, 2000, 2960, 3920],
        },
        {
          name: "flower",
          index: 2,
        ...
        },
        {
          ...
          height: 520,
          xPositions: [
            160, 240, 360, 520, 640, 720, 800, 860, 900, 960, 1120, 1600, 2080,
            2560, 3040, 3520, 4000,
          ],
        },
        {
          ...
          height: 700,
          xPositions: [
            440, 600, 720, 920, 1000, 1280, 1400, 1540, 1600, 1720, 1880, 2360,
            2840, 3320, 3800,
          ],
        },
      ],
    },
    {
      ...
      assets: [
        ...
        },
        {
          ...
          height: 520,
          xPositions: [
            40, 520, 1000, 1480, 1880, 1900, 1920, 1910, 1960, 2440, 2920, 3400,
            3880,
          ],
        },
      ],
      ...
      assets: [
        {
          ...
          width: 520,
          height: 700,
          xPositions: [120, 360, 670, 1320, 1920, 2520, 3120, 3720],
        },
        {
          name: "flower",
          index: 2,
          width: 520,
          height: 520,
          xPositions: [450, 680, 960, 1560, 2160, 2760, 3360, 3960],
        },
        {
          name: "grass",
          index: 1,
        ...
        },
        {
          ...
          height: 700,
          xPositions: [
            520, 1120, 1200, 1180, 1220, 1720, 2320, 2920, 3520, 4120,
          ],
        },
        {
          name: "rock",
    ...
    },
    {
      ...
      assets: [
        ...
        },
        {
          ...
          height: 520,
          xPositions: [
            480, 500, 550, 670, 800, 960, 1280, 1400, 1600, 1780, 2000, 2200,
            2450, 2650, 2880,
          ],
        },
        {
